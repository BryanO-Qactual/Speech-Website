...
import contentArray from './HeadContent2_Content'
import "./HeadContent2.css"

const HeadContent2 = () => {
    const storageName = "HeadContent2"
    const CopySecName = "CopiedHeadContent2"
    const [initialRender, setInitialRender] = useState(true);
    // SECTION - values of each text area 
    const {headContent2: [val, setVal]} = useContext(MainContext) || {}
  ...
  return (
    <div className={"HeadContent2Container newpage"}>
        <div>
            <h1 className={"HeadContent2Title"}>HEAD CONTENT(2)</h1>
