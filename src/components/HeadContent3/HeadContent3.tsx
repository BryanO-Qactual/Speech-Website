...
import contentArray from './HeadContent3_Content'
import "./HeadContent3.css"

const HeadContent3 = () => {
    const storageName = "HeadContent3"
    const CopySecName = "CopiedHeadContent3"
    const [initialRender, setInitialRender] = useState(true);
    // SECTION - values of each text area 
    const {headContent3: [val, setVal]} = useContext(MainContext) || {}
  ...
  return (
    <div className={"HeadContent3Container newpage"}>
        <div>
            <h1 className={"HeadContent3Title"}>HEAD CONTENT(3)</h1>
