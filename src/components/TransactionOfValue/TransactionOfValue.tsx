...
import contentArray from './TransactionOfValueContent'
import "./TransactionOfValue.css"
const TransactionOfValue = () => {
    const storageName = "TransactionOfValue"
    const CopySecName = "CopiedTransactionOfValue"
    const [initialRender, setInitialRender] = useState(true);
    // SECTION - values of each text area 
    const {transactionOfValue: [val, setVal]} = useContext(MainContext) || {}
    ...
    return (
        <div className={"TransactionOfValueContainer newpage"}>
            <div>
                <h1 className={"TransactionOfValueTitle"}>TRANSACTION OF VALUE</h1>
...
export default TransactionOfValue